...
const navigate = useNavigate()
  ...
  useEffect(() => {
    ...
    socket.on("newmsg", (data) => {
      ...
      //  const perseDatac = JSON.stringify(perseData).replace("\\n", "<br>");

      // console.log(JSON.parse(perseDatac)?.at_message);
      // console.log(perseData);
      // const sepLine = text;
      // const sepLinecr = "";
      // // = text.replace('\\n', "<br>")
      //   sepLinecr = text.includes('\\n', "");

      // let text = perseData?.at_message;
      ...
      // // console.log(text);
      // perseData["at_message"] = text;
      // console.log(perseData);


      setMsgList([...msgList, perseData]);
      // setMsgList([...msgList, sepLine]);
    });
  ...
  //for message
  const singleMessage = React.useCallback((singleUser) => {
...
`,
    ...
    return data;
  }, [user?.master_url, user?.sopnoid, searchText]);
  ...
  }, [msgUserList, singleMessage]);

  // filtering data by search
  useEffect(() => {
    singleMessage(singleMsgUser);
  }, [searchText, singleMessage, singleMsgUser]);
