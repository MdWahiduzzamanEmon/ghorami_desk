...
const MessageList = ({
  ...
  const [updateMessengerData, setUpdateMessengerData] = React.useState(null);
...
// =============================================
  // console.log("lastMassage", msg?.at_message);
  // let text = msg?.at_message;
  // console.log(text)
  // let sepLine = text.replace("\\n", "<br>");
  // console.log(sepLine);
  ...
  //   // setUpdateMessengerData(sepLine);
  // }, [])
  // console.log(updateMessengerData)
  return (
    <Box>
